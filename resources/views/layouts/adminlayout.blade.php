...
<html lang="en">
            ...
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="page-sidebar-inner" style="overflow: hidden; width: auto; height: 100%;">
                <div class="page-sidebar-menu">
                    <ul class="accordion-menu">
                        ...
                        @endif
                        <li @if(request()->segment(1) == 'all-orders' || request()->segment(1) == 'active-subscriptions') class="active-page" @endif>
                            <a href="javascript:void(0)">
                                <i class="menu-icon icon-shield"></i><span>Payment </span><i class="accordion-icon fa fa-angle-left"></i>
                            </a>
                            <ul class="sub-menu" style="display: block;">
                                <li class="animation @if(request()->segment(1) == 'all-orders') active-page @endif"><a href="{{url('all-orders')}}">All Subscriptions</a></li>
                                <li class="animation @if(request()->segment(1) == 'active-subscriptions') active-page @endif"><a href="{{url('active-subscriptions')}}">Active Subscriptions</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ url('/logout') }}">
   ...
   <!-- Javascripts -->
      <script>
             function copyCode(element) { var copyText = document.getElementById(element); copyText.select(); document.execCommand("copy"); }
          // Image Priview
